...
Training Cifar10, Cifar100 doesn't show any difference.

Training on synthetic data works sometimes, as seen on Figure \ref{fig:orth_residuals}.

\begin{figure}[h]
   \centering
   \includegraphics[width=0.7\textwidth]{orth_residuals.png}
   \caption{Residuals of orthogonal skip connections during training.}
   \label{fig:orth_residuals}
\end{figure}
